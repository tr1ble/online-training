import { Checkbox, createStyles, IconButton, makeStyles, TableCell, TableHead, TableRow, TableSortLabel, Theme, Toolbar, Tooltip, Typography, lighten, Paper, Table, TableContainer, TableBody, TablePagination, FormControlLabel, Switch } from '@material-ui/core';
...
interface User {
    login: string | number;
    password: string;
    role: "ROLE_STUDENT" | "ROLE_TRAINER" | "ROLE_ADMINISTRATOR" | "ROLE_DEFAULT" | undefined;
    email: string;
}
...
class UserTable extends React.PureComponent<UserTableProps> {
    render() {
        const rows = this.props.userState.users;
